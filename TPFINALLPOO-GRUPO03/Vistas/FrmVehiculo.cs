        ...
        private void dataVehiculo_CurrentCellChanged(object sender, EventArgs e)
        {
            if (this.dataVehiculo.CurrentRow != null)
            {
                ...
                if (frmMostrarVehiculo != null)
                {
                    ...
                    ((FrmMostrarVehiculo)frmMostrarVehiculo).cmbTipo.Text = dataVehiculo.CurrentRow.Cells[7].Value.ToString();
                    ((FrmMostrarVehiculo)frmMostrarVehiculo).cmbClase.Text = dataVehiculo.CurrentRow.Cells[8].Value.ToString();
